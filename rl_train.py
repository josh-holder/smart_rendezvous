...
def train() -> None:
    ...
    parser.add_argument("--env", type=str, default="SpacecraftDock-v0", help="environment ID")
    ...
    gym.envs.register(
            id='SpacecraftDock-v0',
            entry_point='gym_env.docking_gym:DockingGym',
    ...
    thruster_positions = np.array(([0.5,0,0],
                                    [0.5,0,0],
                                    [-0.5,0,0],
                                    [-0.5,0,0],
                                    [0,0.5,0],
    ...
    thruster_force_vectors = -1*np.array(([0.707, 0.707, 0],
                                        [0.707, -0.707, 0],
                                        [-0.707, 0.707, 0],
                                        [-0.707, -0.707, 0],
                                        [0, 0.707, 0.707],
